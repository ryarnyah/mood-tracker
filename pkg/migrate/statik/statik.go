...
func (p *Statik) Open(url string) (source.Driver, error) {
...
// successfully.
func WithInstance(instance http.FileSystem, path string) (source.Driver, error) {
	if instance == nil {
		return nil, fmt.Errorf("expected instance of http.FileSystem")
	}
