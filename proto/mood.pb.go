...
type EntryWithDate struct {
	...
	Record      uint32                 `protobuf:"varint,1,opt,name=record,proto3" json:"record,omitempty"`
	Comment     string                 `protobuf:"bytes,2,opt,name=comment,proto3" json:"comment,omitempty"`
	RecordEntry *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=record_entry,json=recordEntry,proto3" json:"record_entry,omitempty"`
}
...
func (x *EntryWithDate) GetRecordEntry() *timestamppb.Timestamp {
	if x != nil {
...
type RecordStat struct {
	...
	RecordEntry *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=record_entry,json=recordEntry,proto3" json:"record_entry,omitempty"`
...
func (x *RecordStat) GetRecordEntry() *timestamppb.Timestamp {
	if x != nil {
		return x.RecordEntry
	}
	return nil
