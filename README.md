...
- **linux** [amd64](https://github.com/ryarnyah/mood-tracker/releases/download/0.1.0/mood-tracker-linux-amd64) [386](https://github.com/ryarnyah/mood-tracker/releases/download/0.1.0/mood-tracker-linux-386)

```bash
sudo curl -L https://github.com/ryarnyah/mood-tracker/releases/download/0.1.0/mood-tracker-linux-amd64 -o /usr/local/bin/mood-tracker && sudo chmod +x /usr/local/bin/mood-tracker
```
...
```bash
docker run ryarnyah/mood-tracker-linux-amd64:0.1.0 <option>
```
